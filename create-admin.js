...
// Script to create secure admin credentials
async function createAdminUser() {
  ...
  if (!password) {
    ...
    console.log('Example: node create-admin.js admin mySecurePassword123!');
    process.exit(1);
  }
  ...
  try {
    ...
    console.log('2. Never commit admin-credentials.json to version control');
